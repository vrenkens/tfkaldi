...
import ark
from nnetTrainer import NnetTrainer
...
class Nnet:
    ...
    def train(self, featdir, alifile):
        ...
        trainer = NnetTrainer(self.DNN, float(self.conf['initial_learning_rate']), float(self.conf['learning_rate_decay']), num_steps, int(self.conf['numframes_per_batch']))
